...
4. extend(): Appends the elements of another iterable to the end of the list.
another_list = [7, 8, 9]
my_list.extend(another_list)

5. insert(): Inserts an element at a specified position.
my_list.insert(2, 'inserted')

6. remove(): Removes the first occurrence of a specified value.
my_list.remove(3)

7. pop(): Removes and returns an element at a specified index (or the last element if no index is specified).
popped_element = my_list.pop(4)

8. index(): Returns the index of the first occurrence of a specified value.
index_of_four = my_list.index('four')

9. count(): Returns the number of occurrences of a specified value.
count_of_2 = my_list.count(2)

10. sort(): Sorts the elements of the list in ascending order.
my_list.sort()

11. reverse(): Reverses the order of the elements in the list.
my_list.reverse()
